...
haveSameQuestionButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
  var ticketId, count, _yield$axios$post, data;

  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ticketId = haveSameQuestionButton.dataset.ticketid;
          count = haveSameQuestionButton.dataset.count;
          _context.prev = 2;
          _context.next = 5;
          return axios.post("".concat(APP_URL, "/ticket/").concat(ticketId, "/same-question"));
